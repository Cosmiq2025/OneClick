...
export interface OneClickReceiptNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface OneClickReceiptNFT extends BaseContract {
  connect(runner?: ContractRunner | null): OneClickReceiptNFT;
  waitForDeployment(): Promise<this>;

  interface: OneClickReceiptNFTInterface;
  ...
  setBaseURI: TypedContractMethod<[_u: string], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[_u: string], [void], "nonpayable">;
  getFunction(
