...
export type { OneClickReceiptNFT } from "./contracts/OneClickReceiptNFT";
export { OneClickReceiptNFT__factory } from "./factories/contracts/OneClickReceiptNFT__factory";
